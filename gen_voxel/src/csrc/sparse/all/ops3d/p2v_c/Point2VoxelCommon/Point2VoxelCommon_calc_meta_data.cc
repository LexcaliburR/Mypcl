...
std::tuple<std::array<float, 3>, std::array<int, 3>, std::array<int, 3>,
           std::array<float, 6>>
Point2VoxelCommon::calc_meta_data(std::array<float, 3> vsize_xyz,
                                  std::array<float, 6> coors_range_xyz)
{
    std::array<float, 3> vsize;
    std::array<int, 3> grid_size, grid_stride;
